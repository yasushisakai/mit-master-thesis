...
%% wishing to get rid of @iiminipage error
...
\include{chapters/3/extendedExamples}
\include{chapters/4/implementation}
\include{chapters/5/discussion}
\include{chapters/6/conclusion}

\appendix
\include{appendix/A/traditionalMethods}
\include{appendix/B/bad_parts}
\include{appendix/C/afterQuestions}
\include{appendix/D/passingObservation}
\include{appendix/E/CNN}
\include{appendix/G/good_parts}
\include{appendix/H/couhes}
\include{appendix/I/api}
\include{appendix/J/repos}
\nocite{*}
\include{biblio}
\end{document}
